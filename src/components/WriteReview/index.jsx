...
export const WriteReview = ({ setWriteReviewOpen }) => {
  return (
    <div className={styles.write_review}>
      <div className={styles.write_reviewBlock}>
        ...
        <h3 className={styles.write_reviewBlock__title}>
          Напишите текст отзыва
        </h3>
        <form className={styles.write_reviewBlock__form}>
          <textarea
            placeholder="Введите текст"
            className={styles.write_reviewBlock__formText}
          ></textarea>
          <button type="button" className={styles.write_reviewBlock__formBtn}>
            Сохранить
          </button>
        </form>
      </div>
