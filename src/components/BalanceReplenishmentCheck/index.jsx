    ...
    <div className={styles.balance_replenish}>
      <div className={styles.balance_replenishBlock}>
        <div
          ...
          onClick={() => {
            setBalanceReplenishmentCheckOpen(false);
          }}
        >
          <svg
            width="26"
        ...
        <h4 className={styles.balance_replenishBlock__title}>Банк</h4>
        <ul className={styles.balance_replenishBlock__list}>
          <li className={styles.balance_replenishBlock__listItem}>Сумма</li>
          <li className={styles.balance_replenishBlock__listItem}>
            Торговая точка
          </li>
          <li className={styles.balance_replenishBlock__listItem}>Дата</li>
          <li className={styles.balance_replenishBlock__listItem}>
            Номер карты
          </li>
        </ul>
        <p className={styles.balance_replenishBlock__text}>
          Пожалуйста, проверьте детали покупки и введите код, отправленный на
          номер +78989*****32
        </p>
        <form className={styles.balance_replenishBlock__form}>
          ...
          />
          <p className={styles.balance_replenishBlock__formText}>
            Срок действия истекает через <span>1:00</span>
          </p>
          <button
            className={styles.balance_replenishBlock__formBtn}
            type="button"
          >
